(function(){
  ...
  document.addEventListener('DOMContentLoaded',()=>{
    ...
    if(tabMenu) tabMenu.addEventListener('click',()=>{ setActive(tabMenu); menuHeader.style.display=''; statsSection.style.display=''; menuSection.style.display=''; categoriesSection.style.display='none'; specialsSection.style.display='none'; loadMenu(); });
    if(specialsTab) specialsTab.addEventListener('click',()=>{ setActive(specialsTab); menuHeader.style.display='none'; statsSection.style.display='none'; menuSection.style.display='none'; categoriesSection.style.display='none'; specialsSection.style.display=''; loadSpecials(); });
